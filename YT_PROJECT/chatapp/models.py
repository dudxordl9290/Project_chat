...
class Room(models.Model):
    ...
    room_view = models.IntegerField(null=False, default=0)
    room_like = models.IntegerField(null=False, default=0)
    ...
    def __str__(self):
        return f"{self.room_title}, {self.room_content}, {self.room_image1}, {self.room_image2}, {self.room_image3}, {self.room_creater}, {self.room_date}, {self.room_view}, {self.room_like} creat!!"
